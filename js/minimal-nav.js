...
(function() {
    ...
    if (nav) {
        ...
        nav.addEventListener('click', function(e) {
            ...
            loadingBar.style.cssText = 'width:150px;height:24px;font-family:monospace;font-size:12px;color:#fff;letter-spacing:1px;text-align:left;border:1px solid #fff;padding:4px 0 4px 3px;box-sizing:border-box;line-height:1;display:flex;align-items:center;';
